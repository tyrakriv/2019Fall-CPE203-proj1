...
//   {
//      Optional<Entity> notFullTarget = world.findNearest(entity.position, //added world. and took out world parameter
//         EntityKind.FISH);
//
...
//      ImageStore imageStore, EventScheduler scheduler)
//   {
//      Optional<Entity> crabTarget = world.findNearest(entity.position, EntityKind.SGRASS); // added world. and took our world param
...
//         entity.unscheduleAllEvents(scheduler);
//
...
//         target.unscheduleAllEvents(scheduler);
//
//         return true;
//      } else {
...
//               occupant.get().unscheduleAllEvents(scheduler);
//            }
//
//            octo.moveEntity(world, nextPos);
//         }
//         return false;
//      }
//   }
...
//   {
//      if (Entity.isOccupied(world, entity.position))
//      {
...
//         Entity temp = null;
//         temp.setOccupancyCell(world, pos);
//      }
//   }
...
//   {
//      if (Entity.isOccupied(world, pos))
//      {
//         return Optional.of(Entity.getOccupancyCell(world, pos));
//      }
//      else
//      {
//         return Optional.empty();
